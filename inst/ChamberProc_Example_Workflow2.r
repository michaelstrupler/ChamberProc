...
dsChunk <- dsChunk_raw %>% group_by(iChunk) %>% ungroup() #%>% slice(seq(1, n(), 5)) %>% ungroup()
...
resDur_H2O <- plotDurationUncertaintyRelSD( df
                                            , colTime = "TIMESTAMP"
                                            , colConc = "H2Oppt"
                                            , colTemp="AirTemp"
                                            , volume = chamberVol
                                            ...
                                            , maxSdFluxRel = 0.3 #this should be relative to the median (e.g. 10% von median)
                                            , nDur = 10
                                            , durations = seq(65,max(as.numeric(df$TIMESTAMP) - as.numeric(df$TIMESTAMP[1])),20)
)
resDur_H2O$duration
...
# #
resDur_CH4 <- plotDurationUncertaintyRelSD( df
                                            , colTime = "TIMESTAMP"
                                            , colConc = "CH4_dry"
                                            , colTemp="AirTemp"
                                            , volume = chamberVol
...
#
resDur_NH3 <- plotDurationUncertaintyRelSD( df
                                            , colTime = "TIMESTAMP"
                                            , colConc = "NH3_dry"
                                            , colTemp="AirTemp"
                                            , volume = chamberVol
                                            ...
                                            , maxSdFluxRel = 0.3 #this should be relative to the median (e.g. 10% von median)
                                            , nDur = 5
                                            , durations = seq(65,max(as.numeric(df$TIMESTAMP) - as.numeric(df$TIMESTAMP[1])),30)
)
...
#
resDur_N2O <- plotDurationUncertaintyRelSD( df
                                            , colTime = "TIMESTAMP"
                                            , colConc = "N2O_dry"
                                            , colTemp="AirTemp"
                                            , volume = chamberVol
